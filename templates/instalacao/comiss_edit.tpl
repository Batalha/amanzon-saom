			...
			<div class="panel-body">
				...
				<div class="row">
					<div class="form-group col-md-6">
						<div class="">
							<input class="form-control autosave" type="text" name="registro_concessionaria" id="registro_concessionaria" value="{$obj.registro_concessionaria}" placeholder="Registro Concessionária" />
						</div>
					</div>
					<div class="form-group col-md-6">
						<div class="">
							<input class="form-control autosave" type="text" name="ope_eutelsat" id="ope_eutelsat" value="{$obj.ope_eutelsat}" placeholder="Nome do Operador(a) do Satelite" />
						</div>
					</div>
				</div>
				<div class="row">
					<div class="form-group col-md-6">
						<div class="">
							<input class="form-control autosave" type="text" id="val_crosspol" name="val_crosspol" value="{$obj.val_crosspol}"  placeholder="Valor do cross-pol Satelite"/>
						</div>

					</div>
					<div class="form-group col-md-6">
						<div class="">
							<input class="form-control autosave" type="text" id="elevacao_comiss" name="elevacao_comiss"  value="{$obj.elevacao_comiss}" placeholder="Elevação"/>
						</div>
					</div>
				</div>
				<div class="row">
					...
					<div class="form-group col-md-6">
						<div class="">
							<input class="form-control autosave" type="text" id="azimute_comiss" name="azimute_comiss" value="{$obj.azimute_comiss}" placeholder="Azimute" />
						</div>
					</div>
		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<div class="row">
					<div class="form-group col-md-6">
						<div class="">
							<input class="form-control autosave" type="text" id="snr_comiss" name="snr_comiss" value="{$obj.snr_comiss}"  placeholder="Valor de SNR na VSAT"/>
						</div>
					</div>
					<div class="form-group col-md-4">
						<div class="">
					...
					<div class="form-group col-md-2">
						<div class="">
							<input class="form-control autosave" type="text" name="antena_ns_comiss" id="antena_ns_comiss" value="{$obj.antena_ns_comiss}" />
						</div>
					</div>
				</div>
				<div class="row">
					...
					<div class="form-group col-md-6">
						<div class="">
							<input class="form-control" name="nsodu_comiss" id="nsodu_comiss" placeholder="Número de série ODU/BUC"
								   onblur="javascript:atualizaODU();" value="{$obj.nsodu_comiss}"
								   type="text" />
			...
			<div class="panel-body">
				...
				<div class="row">
					...
					<div class="form-group col-md-3 cabo_input" style="{if $obj.test_cabo != 1}visibility: hidden;{/if}">
						<div class="">
							<input class="form-control autosave_sp" type="text" name="comp_cabo_comiss" id="comp_cabo_comiss"  value="{$obj.comp_cabo_comiss}" placeholder="Valor"/>
						</div>
					</div>
					<div class="form-group col-md-3 cabo_input" style="{if $obj.test_cabo != 1}visibility: hidden;{/if}">
						<div class="">
							<input class="form-control autosave_sp" type="text" name="tipo_cabo_comiss" id="tipo_cabo_comiss" value="{$obj.tipo_cabo_comiss}" placeholder="Tipo de Cabo"/>
						</div>
					</div>
				</div>
				<div class="row">
				...
				<div class="row">
					<div class="form-group col-md-6">
						<div class="input-group">
							<span class="input-group-addon">
								<input class="check_obrigatorio" type="checkbox" name="test_prtg" id="test_prtg" onClick="showFields(this)" {if $obj.test_prtg eq 1}checked{/if} />
							</span>
					...
					<div class="form-group col-md-6">
						<div class="input-group">
							<span class="input-group-addon">
								<input class="check_obrigatorio" type="checkbox" name="test_notificacao_inicio" id="test_notificacao_inicio" onClick="showFields(this)" {if $obj.test_notificacao_inicio eq 1}checked{/if} />
							</span>
		...
		<tr>
			...
			<td>
				<form method="post" enctype="multipart/form-data" name="form_termo_aceite" action="Instalacao/uploadTermo" id="form_termo_aceite" >
					...
					<input type="hidden" name="id" id="id" value="{$obj.idinstalacoes}"/>
					<input
							type="file"
				...
				<div id="form_termo_aceite_result">
