<center>
<form action="AgendaInstal/create" method="POST" id="fRelCreate" class="form" >
    ...
    <div style="float:left; margin-right:5px; padding:5px;width:50%">
        ...
        <table class="tbForm">
            ...
            <tr>    
                ...
                <td >
                    <input type="text" name="cod_area" id="cod_area" size="10" />
                </td>
            </tr>
            <tr>    
                <td>
    ...
    <br />
    <center><input type="button" value="Cadastrar" onClick="javascript:sendPost('Realocacao/create','fRelCreate')" /></center>
    <br />
    </fieldset> 
</form>
</center>