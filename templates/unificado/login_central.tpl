	...
	<div id="loginContener">
        <div id="loginInterno">
            ...
            <form action="{$prodemge}/Usuario/login" method="post" name="login_central">
                ...
                <div id="loginLogo"><img src="../public/imagens/logo_gee.png" height="50" width="335" alt="GlobalEagle"></div>
        ...
        <div id="marca">
            ...
            Webmaster/Database Admin: <a href="mailto:celio.batalha@globaleagle.com">Célio Batalha</a>.
        </div>
    </div>
