	    ...
	    <div id='painelAgend' class="painel" style='visibility: hidden' >
	       ...
	       <table >
	          ...
	          <tr class="trCor">
	               <td><a href="#" onClick="getAjaxForm('OS/liste','conteudo',{ldelim}where:'NOT EXISTS ( SELECT * FROM agenda_instal WHERE agenda_instal.os_idos = idos )',ajax:1{rdelim})" >Pendentes</a></td>
	               <td><div id="resultPen">indefinido</div></td>
	               <td><a href="#"  onClick="getAjaxForm('OS/liste','conteudo',{ldelim}where:'NOT EXISTS ( SELECT * FROM instalacoes WHERE instalacoes.os_idos = idos AND instalacoes.comiss) AND prazoInstal < CURDATE( )',ajax:1{rdelim})">Comissionadas</a></td>
	               <td><div id="resultStatusAberto"></div>
	           </tr>
	           <tr class="trsCor">
	               <td><a href="#" onClick="getAjaxForm('OS/liste','conteudo',{ldelim}where:'EXISTS ( SELECT * FROM agenda_instal WHERE agenda_instal.os_idos = idos AND NOT agenda_instal.confirm)',ajax:1{rdelim})">Pendente Confirmação</a></td>
	               <td><div id="resultAgen">indefinido</DIV></td>
	               <td><a href="#"  onClick="getAjaxForm('OS/liste','conteudo',{ldelim}where:'NOT EXISTS ( SELECT * FROM instalacoes WHERE instalacoes.os_idos = idos AND instalacoes.comiss) AND prazoInstal < CURDATE( )',ajax:1{rdelim})">Prazo de instalação vencido</a></td>
	               <td><div id="resultStatusVenc"></div>    
	           </tr>
	           <tr class="trCor">
	               <td><a href="#" onClick="getAjaxForm('OS/liste','conteudo',{ldelim}where:' EXISTS ( SELECT * FROM agenda_instal WHERE agenda_instal.os_idos = idos AND agenda_instal.confirm)',ajax:1{rdelim})">Confirmados</a></td>
	               <td><div id="resultConfirm">indefinido</div></td>
	               <td><a href="#" onClick="getAjaxForm('OS/liste','conteudo',{ldelim}where:' EXISTS ( SELECT * FROM instalacoes WHERE instalacoes.os_idos = idos AND instalacoes.comiss)',ajax:1{rdelim})" >Instalações Concluídas</a></td>
	    ...
	    <div id='painelIncid' class="painel"  style='visibility: hidden'>
			...
			<table >
	        	<tr>
	           	...
	           	<tr class="trCor">
	            	<td>
	            		<a href="#" onClick="getAjaxForm('Instalacao/liste','conteudo',{ldelim}param:'ISNULL(packetshapper)',ajax:1{rdelim})">
	            			Abertos
	            		</a>
	            	</td>
	           	...
	           	<tr class="trsCor">
	            	<td>
	            		<a href="#" onClick="getAjaxForm('Instalacao/liste','conteudo',{ldelim}param:'ISNULL(webnms)',ajax:1{rdelim})">
	            			Em atendimento
	            		</a>
	            	</td>
				...
				<tr class="trCor">
	            	<td>
	               		<a href="#" onClick="getAjaxForm('Instalacao/liste','conteudo',{ldelim}param:'(ISNULL(webnms) OR ISNULL(packetshapper))',ajax:1{rdelim})">
	               			Finalizados
	               		</a>
	               	</td>
