...
<div id="formulario_justifica_desaprovacao_termo_justificativa">
	...
	<form name="form_justifica_desaprovacao_termo_responsabilidade" id="form_justifica_desaprovacao_termo_responsabilidade" 
		method="post" action="TermoResponsabilidade/justificaDesaprovacao" enctype="multipart/form-data">
		...
		<table>
			<tr>
				...
				<td style="width:100px;text-align:left;">
					<textarea name="comentario" id="comentario" style="width:300px;height:200px;">{$termo.comentario}</textarea>
				</td>
			</tr>
			<tr>
