...
//	function delete_inbox($data){
//		$imap_delete = imap_open($data['email']['hostname'], $data['email']['username'], $data['email']['password']) or die ('Cannot connect to yourdomain.com: ' . imap_last_error());
//
//		imap_delete($imap_delete, 1);
//		imap_expunge($imap_delete);
//		imap_close($imap_delete);
//
//	}
