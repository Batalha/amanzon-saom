...
class DBLog extends DBModel 
{
	...
	{
		$sql = "INSERT INTO log (data, usuarios_idusuarios, tabelareferencia, idreferencia, log_acao_idlog_acao, observacoes) 
			VALUES ('{$this->data}','{$this->usuarios_idusuarios}','{$this->tabelareferencia}','{$this->idreferencia}','{$this->log_acao_idlog_acao}','{$this->observacoes}')";
		//exit($sql);
