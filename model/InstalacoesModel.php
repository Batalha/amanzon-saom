...
class InstalacoesModel extends ZendModel
{
	...
	public function gettipo_cabo_comiss ()
	{
		return $this->tipo_cabo_comiss;
	}
	...
	public function settipo_cabo_comiss ($tipo_cabo_comiss)
	{
		$this->tipo_cabo_comiss = $tipo_cabo_comiss;
	}
	...
	public function setos_idos ($os_idos)
    {
	...
	{
		if( empty($this->idinstalacoes) )
			return "Id da Instalação não declarado.";

		$where = " idinstalacoes = '{$this->idinstalacoes}' ";
