...
class DBCronometro_interrupcao extends DBModel
{
	...
	//padrao
	protected $tabela = 'cronometro_interrupcao';
    protected $rel    = array();
    protected $fgk    = array();
    ...
    {
    	$sql = "SELECT idcronometro_interrupcao, cronometro_idcronometro, hora_comeco, hora_fim, motivo FROM cronometro_interrupcao WHERE idcronometro_interrupcao = {$this->idcronometro_interrupcao}";
    ...
    {
    	$sql = "UPDATE cronometro_interrupcao SET hora_fim = '".date('Y-m-d H:i:s')."' WHERE idcronometro_interrupcao = ".$this->idcronometro_interrupcao." ";
    	if($this->query($sql))
    	{
