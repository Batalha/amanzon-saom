...
class PerguntasComissionamentoBO extends DBModel//PerguntasComissionamentoModel////
{
    ...
    protected $tabela = 'perguntas_comissionamento';
...
// 		$arrReturn['msg']     = $formPerguntasComissionamento['test_sl2000'];
// 		die_json($arrReturn);
