...
//	protected $last_user_cross_pol; // TODO: apagar
	protected $test_geo;
	protected $ebno_comiss;
	protected $eirp_comiss;
//	protected $last_user_tx;
...
//		$this->MunicipiosBO = new Municipios_spBO( $adapter );
	...
	public function getresp_user_comiss ()
	{
		return $this->resp_user_comiss;
	}
	...
	public function setresp_user_comiss ($resp_user_comiss)
	{
		$this->resp_user_comiss = $resp_user_comiss;
	}
