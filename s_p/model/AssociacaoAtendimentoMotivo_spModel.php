...
class AssociacaoAtendimentoMotivo_spModel extends Zend_spModel
{
		
	protected $_name = 'atendimento_motivo_responsavel_sp';
	protected $_primary = 'idatendimento_motivo_responsavel';
	
	protected $_referenceMap = array(
        'Instalacao' => array(
            'columns'           => 'idatendimento',
            'refTableClass'     => 'AtendVsat_spBO',
            'refColumns'        => 'idatend_vsat'
        ),
        'Motivo' => array(
            'columns'           => 'idmotivo',
            'refTableClass'     => 'MotivoAtendimento_spBO',
            'refColumns'        => 'idmotivo_atendimento'
        ),
        'Responsavel' => array(
            'columns'           => 'idresponsavel',
            'refTableClass'     => 'ResponsavelAtendimento_spBO',
