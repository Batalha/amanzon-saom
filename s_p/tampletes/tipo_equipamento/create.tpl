...
<form action="TipoEquipamento_sp/create" method="POST" id="fEqCreate" class="form" >
    ...
    <br />
    <center><input type="button" value="Enviar" onClick="javascript:sendPost('TipoEquipamento_sp/create','fEqCreate')" /></center>
</form>