...
<form action="TipoEquipamento_sp/create" method="POST" id="fEqEdit" class="form" >
    ...
    <br />
    <center><input type="button" value="Salvar" onClick="javascript:sendPost('TipoEquipamento_sp/edit','fEqEdit')" /></center>
</form>