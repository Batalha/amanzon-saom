...
<form action="Instalacao_sp/create" method="POST" id="form_data_aceite" class="form" >
    ...
    <table>
    	<tr>
    		<td style="text-align:right;">Data de Aceite:</td>
    		<td>&nbsp;</td>
    		...
    		onClick="
            	...
            	{ldelim}
	                ...
	                {ldelim}
	        			...
	        			{ldelim}
	        				sendPost('Instalacao_sp/edit_data_aceite','form_data_aceite');
	        			{rdelim}
	        			else
	        			{ldelim}
