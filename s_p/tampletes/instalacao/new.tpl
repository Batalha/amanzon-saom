    ...
    <form action="Instalacao_sp/create" method="POST" id="FINSCreate" class="form" >
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        <input type="text" id="os_iplan" name="os_iplan" class='form-control' value="{$obj.rel.os_sp.iplan}" placeholder="IP Lan"/>
                    </div>
                    <div class="form-group col-md-6">
                        <input type="text" id="os_ipdvb" name="os_ipdvb" class='form-control' value="{$obj.rel.os_sp.ipdvb}" placeholder="IP DVB"/>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-md-6">
                        <input type="text" id="mascaraLan" name="mascaraLan" class='form-control'  placeholder="Mascara Lan"/>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-md-6">
                ...
                <div class="row">
                    <div class="form-group col-md-12 text-center">
                        <input type="button" class="btn btn-primary" value="Cadastrar dados" onClick="javascript:sendPost('Instalacao_sp/create','FINSCreate')" />
                    </div>
                </div>
            </div>
        </div>
