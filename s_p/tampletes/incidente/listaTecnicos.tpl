...
<table class="tbLista tableTecnicos">
    ...
    <tbody>
	    {foreach from=$listaTecnicos item=obj}
		    ...
		    <tr class="{$rowCss}" onClick="javascript:getAjaxForm('Incidente_sp/view','conteudo',{ldelim}param:{$obj.idincidentes},ajax:1{rdelim})" onMouseOver="javascript:onOver(this)" onMouseOut="javascript:onUp(this,'{$rowCss}')">
