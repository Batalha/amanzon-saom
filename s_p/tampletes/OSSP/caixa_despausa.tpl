...
<div style="border:1px solid #000;margin-top:5px;width:300px;padding:5px;">
	...
	<input type="button" id="submitParalisacao" value="Enviar desparalização" onClick="javascript:if($('#campoDataParalisacao').val()!=''){ldelim}sendPost('OSSP/despausa','FOSCreate');{rdelim}" style="margin-top:5px;" />
	&nbsp;&nbsp;
