...
class Municipio_sp extends Controller 
{
    protected $tplDir = 's_p/tampletes/municipio';
    
    function __construct() 
    {
        parent::__construct();
        $this->DB = new DBMunicipio_sp();
    }  
    ...
    public function delete()
    {
    	...
    	$sql = "DELETE FROM municipios_sp WHERE idmunicipios_sp = '{$this->dadosP['form']['idmunicipios_sp']}'";
