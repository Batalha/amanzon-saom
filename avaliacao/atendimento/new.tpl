...
<body>
    <form action="/avaliacao/satisfacao.php" method="post">
        <input type="hidden" name="idatend" value="{$idatend}">
        <div class="header">
        ...
        <div class="dataSelector">
            <div>
                <div class="ui-widget">
                    <b>Ticket #:&nbsp;</b><span>{$numberInc}</span>
                </div>
            </div>
        </div>

        <div class="jumbotron">
            <div class="container"  {if !$url}id="stiloDisabled"{else}id="stiloEnabled"{/if}>
                <div class="row-fluid clearfix">
                    <div class="span12">
                        <h4 style="margin-top:0px;font-weight: normal;">
                            Tipo de Ticket:&nbsp;
                            <span> {$nomeSolicitacao} / {$nomeTipo} </span>
                        </h4>
                    </div>
                </div>
                {if !$url}
                ...
                <div class="card border-primary"  style="background-color: #E9ECEF;">
                    <div class="card-body">
                        ...
                        <table class="table" {if !$url}id="radioDisabled"{else}id="radioEnabled"{/if} style="width: 80%;">
                            <tbody>
                            <tr>
                                <td>
                ...
                <div class="card border-primary"  style="background-color: #E9ECEF;">
                    <div class="card-body">
                        ...
                        <textarea {if !$url}readonly{else}{/if} name="comentarios" rows="3" cols="20" id="" style="width:100%;"></textarea>
                    </div>
                </div>
                <br>
                <div class="row">
