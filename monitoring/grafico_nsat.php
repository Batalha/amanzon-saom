...
{
    $fp = fopen("img/img_nsat/cookie_".$grafid.".txt", "w");
    fclose($fp);
    $login = curl_init();
...
{
    $fp = fopen("img/img_nsat/zabbix_graph_".$grafid.".png", "w");
    $local_graf = "/monitoring/img/img_nsat/zabbix_graph_".$grafid.".png";
    $ch = curl_init();
    ...
    <script type="text/javascript" src="js/grafico_nsat.js"></script>
    <center>
            ...
            <div id="contener">
                ...
                <div id="acoes">
                    <table  border="0" width="100%">
                        <tr>
                            <td width="13%">
                                <select name="nsat" id="nsat" onchange="return btmenus(this)";>
                                    <option value="0"><b>Escolha:</b></option>
                                    <option value="1"><b>NSAT-TAPAUA:</b></option>
                                    <option value="2"><b>NSAT-EIRUNEPE:</b></option>
                                </select>
                            </td>
                            <td align="left">
                                <div id="para"></div>
    ...
    <div id="nsat_tapaua" hidden="">
        <table border="0">
            <tr>
                <td width="16%"><input type="radio"  <?php echo ($_SESSION['grafico'] == '2570')? 'checked':'' ?> name="graf" value="2570">&nbsp;&nbsp;Traffic</td>
    ...
    <div id="nsat_eirunepe" hidden="">
        <table border="0">
            <tr>
                <td width="16%"><input type="radio"  <?php echo ($_SESSION['grafico'] == '2574')? 'checked':'' ?> name="graf" value="2574">&nbsp;&nbsp;Traffic</td>
                <!--                            <td width="10%"><input type="radio"  name="graf" value="554">&nbsp;&nbsp;Rx</td>-->
                <!--                <td width="10%"><input type="radio" --><?php //echo ($_SESSION['grafico'] == '570')? 'checked':'' ?><!--  name="graf" value="570">&nbsp;&nbsp;Ping</td>-->
                <td width="10%">&nbsp;&nbsp;Periodo :</td>
                <td width="15%"><select name="periodo">
                ...
                <td><input type="submit" name="btNsat" value="Gerar Grafico"></td>
            </tr>
        </table>
    </div>
