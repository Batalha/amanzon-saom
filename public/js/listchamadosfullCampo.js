...
function desenhaTabelaAcompanhamentosChamadosFullCampo()
{
	$("#flexmeListChamadosFull").flexigrid({
    	url: 'Acompanhamento/acompanhamentoCampoConteudo',
        dataType: 'json',
        colModel : [
        ...
        height: 520,
        singleSelect: true,
        onSuccess: successFlexigridListChamadosFullCampo,
        onError: successFlexigridListChamadosFullCampo,
        showToggleBtn: false
	});
}
...
function successFlexigridListChamadosFullCampo()
{
	...
	$('#ultimaRequisicao').val(dataAtual);
	var campos = ["tecnico",
	              "numero_qtd",
	              "tipo",
	              "data_inicio",
	...
	var controle = new controleGridCampo();
	controle.reconstuirGrid(
							campos,
							'Acompanhamento/acompanhamentoComConteudoFiltro',
							'',
...
function controleGridCampo()
{
	...
	this.cronometro = function(){
		$('#flexmeListChamadosFull td[abbr="tempo_vencimento"] div').each(function(){
			...
			if(tempo!='Finalizado')
			{
				...
				controle = new controleGridCampo;
				controle.cronoCampo(
	...
	this.cronoCampo = function(hor,min,seg,local){
		var timeCrono;
		StartCrono_corridoCampo(hor,min,seg,local);
	}
...
/* ##### EXTRAS #### */
	 ...
	 */
		function StartCrono_corridoCampo(hor,min,seg,local){
