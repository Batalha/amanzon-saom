...
{	
	...
	var miniform = "<input type='text' name='sat_vsat_code' id='sat_vsat_code' value='"+value+"' />";
	...
	{
		$('#conteudo').append("<input onclick='salvaFormeutelsat()' id='buttonSalvaEutelsatcode' type='button' class='btn btn-primary' value='Salvar Eutelsat Codes Modificados'/>");
	}
}
