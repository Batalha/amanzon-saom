...
function desenhaTabelaAcompanhamentosChamadosFullCom()
{
	//alert('chamou');
	$("#flexmeListChamadosFull").flexigrid({
        ...
        height: 520,
        singleSelect: true,
        onSuccess: successFlexigridListChamadosFullCom,
        onError: successFlexigridListChamadosFullCom,
        showToggleBtn: false
	});
}
...
function successFlexigridListChamadosFullCom()
{
...
function controleGridCom()
{
	...
	this.cronoCom = function(hor,min,seg,local){
		var timeCrono;
