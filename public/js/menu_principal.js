...
function chama_item_menu_principal( menu , submenu, hash )
{
	...
	switch( menu )
	{
		...
		case 'relatorio_inc_bh':
			if(submenu == 'create'){
				getAjaxForm('Incidente/periodo')
			}
        ...
        case 'incidentes_sp':
            ...
            }else if( submenu == 'create_sol' ){
				getAjaxForm('Incidente_sp/create','',{param:'solicitacao',ajax:1});

			}else if( submenu == 'create'){
                getAjaxForm('Incidente_sp/create');
            }
		...
		case 'relatorio_inci':
			if(submenu == 'create_r'){
				getAjaxForm('Incidente_sp/periodo')
			}
		...
		case 'cliente_sp':
			...
			$('#cliente').addClass('item_active');

			if( submenu == 'lista' ) {
				getAjaxForm('Cliente_sp/liste');
			}else if( submenu == 'lista_emails' ){
				getAjaxForm('Cliente_sp/liste_emails');
			}else if( submenu == 'create' ){
				getAjaxForm('Cliente_sp/create');
			}else if( submenu == 'edicao' ){
				getAjaxForm('Cliente_sp/novosla');
			}
		...
		case 'interno_sp':
			...
			$('#interno').addClass('item_active');

			if( submenu == 'lista' ){
				getAjaxForm('Interno_sp/liste');
			}else if( submenu == 'create' ){
				getAjaxForm('Interno_sp/create');
			}
